...
import login_app.models.Game;

public class Main {
    private static ArrayList<User> listUser = new ArrayList<>();
    private static ArrayList<Profile> listUserProfile = new ArrayList<>();
    private static ArrayList<Game> favoriteGames = new ArrayList<>();
    ...
    private static void showDetailUser(Profile profile) {
        ...
        if (favoriteGames.isEmpty()) {
            System.out.println("Belum ada game favorit.");
        } else {
            System.out.println("Game Favorit : ");
            for (Game game : favoriteGames) {
                System.out.println("Nama Game : " + game.getName());
    ...
    private static void addFavoriteGame() {
        ...
        System.out.println("Publisher Game");
        System.out.print("> ");
        String publisher = sc.nextLine();

        Game game = new Game(name, genre, publisher);
        favoriteGames.add(game);

        System.out.println("Game favorit berhasil ditambahkan!");
